...
document.querySelector('.read-more').addEventListener('click', function () {
  if (this.innerHTML === 'Показать все') {
    ...
    // document.querySelectorAll(".swiper-slide__show965").forEach(el => el.style.display = 'flex');
    ...
    document.querySelectorAll(".swiper-slide__768").forEach(el => el.style.display = 'none');
    document.querySelectorAll(".swiper-slide__show965").forEach(el => el.style.display = 'none');
    this.innerHTML = 'Показать все';
  } else {
    document.querySelectorAll(".swiper-slide__768").forEach(el => el.style.display = 'none');
    document.querySelectorAll(".swiper-slide__show965").forEach(el => el.style.display = 'flex');
